...
var cylinderMaterial3 = new THREE.MeshLambertMaterial( 'blue' );
...
var cylinderMaterial4 = new THREE.MeshLambertMaterial( 'purple' );
...
function rotateCylinder()
{
  ...
  if(animationOn)
  {
    ...
    cylinder3.matrix.multiply(mat4.makeTranslation(-1.0, -1.0, -2.0)); // T1
